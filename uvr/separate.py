...
class SeperateAttributes:
    def __init__(
        ...
        self.cached_source_callback = cached_source_callback
        ...
        if main_model_primary and self.is_multi_stem_ensemble:
            self.primary_stem, self.secondary_stem = main_model_primary, secondary_stem(
                main_model_primary
            )
        ...
        if model_data.process_method == DEMUCS_ARCH_TYPE:
            self.demucs_stems = (
                ...
                if not main_process_method in [MDX_ARCH_TYPE, VR_ARCH_TYPE]
                else None
            )
